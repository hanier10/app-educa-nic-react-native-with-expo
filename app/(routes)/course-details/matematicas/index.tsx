      ...
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.description}>
            ...
            una de nuestras vidas; nos ayuda a resolver problemas complejos con
            mayor facilidad, a contar con un razonamiento matemático capaz de
            ser crítico, analítico y práctico. En definitiva, a vivir con éxito,
            en un mundo cada vez más desafiante ante los cambios sociales y los
