        ...
        <View style={styles.container}>
          ...
          <View style={styles.content}>
            ...
            <Text style={styles.description}>
              ...
              conocimientos, habilidades y actitudes necesarias para comprender
              la complejidad de la realidad social y el devenir de nuestra
              sociedad. Así, esta asignatura busca promover aprendizajes que
              representen un aporte significativo para ejercer una participación
              ciudadana activa y enfrentar los desafíos de desenvolverse en un
              mundo cada vez más dinámico, plural y cambiante.
            </Text>
