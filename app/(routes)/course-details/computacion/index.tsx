...
export default function Index() {
  ...
  const showFirstTermGrade = () => {
    setFirstTermGrade(87);
  };

  const showSecondTermGrade = () => {
    setSecondTermGrade(99);
  };

  const showThirdTermGrade = () => {
    setThirdTermGrade(92);
  };
        ...
        <View style={styles.container}>
          ...
          <View style={styles.content}>
            ...
            <Text style={styles.description}>
              ...
              aplicación ofimático. Algunos de los temas que se pueden abordar
              en la asignatura de computación son: Ciudadanía digital, Análisis
              de problemas, Algoritmos y programación, Almacenamiento de datos,
