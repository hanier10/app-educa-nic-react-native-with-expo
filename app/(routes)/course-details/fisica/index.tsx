        ...
        <View style={styles.container}>
          ...
          <View style={styles.content}>
            ...
            <Text style={styles.description}>
              La física es una asignatura que estudia la naturaleza, las
              propiedades de la materia y la energía, y las leyes fundamentales
              del universo. Se trata de una de las ciencias básicas más antiguas
              y es un motor de innovación tecnológica.
            </Text>
            <View style={styles.teacherInfo}>
              <Image
                source={require("../../../../assets/images/docente3.jpeg")}
                style={styles.teacherImage}
              />
              <Text style={styles.teacherName}>Docente: Marlon Calero</Text>
            </View>
