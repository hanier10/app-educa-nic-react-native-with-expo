      ...
      return (
        <View style={styles.descriptionContainer}>
          <Text style={styles.descriptionText}>
            La asignatura de Ciencias Naturales es fundamental para comprender
            la vida y los sistemas naturales. En este curso, los estudiantes
            explorarán temas como la estructura celular, la genética, la
            evolución, la ecología y la fisiología humana. A través de
            experimentos prácticos y actividades de laboratorio, los estudiantes
            aprenderán a aplicar el método científico para investigar y resolver
            problemas en el mundo natural.
          </Text>
        </View>
      );
    }
  ...
  return (
    <ScreenWrapper bg="white">
      ...
      <ScrollView style={styles.container}>
        ...
        <Image
          source={require("../../../../assets/images/asignaturaciencias.jpg")}
          style={styles.image}
          resizeMode="cover"
        />

        <View style={styles.detailsContainer}>
          <Text style={styles.grade}>Septimo Grado</Text>
          <Text style={styles.timeDay}>
            9:00 AM - 10:45 AM • Lunes{" "}
            <Ionicons name="star" size={16} color="#FFD700" /> 33 Estudiantes
          </Text>
        </View>
